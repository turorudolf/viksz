...
#contract = make_contract('VIX3M', 'IND', 'CBOE', 'CBOE', 'USD');tradeType = 'TRADES'
contract = make_contract('VXZ', 'STK', 'SMART', 'SMART', 'USD');tradeType = 'TRADES'
...
conn.reqHistoricalData(tickerID, contract, '', '1 W', '5 mins', tradeType, 1, 1)
