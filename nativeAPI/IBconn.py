...
class TestClient(EClient):
    ...
    def get_IB_historical_data(self, ibcontract, durationStr, barSizeSetting, whatToShow,
...
class createConnection(TestWrapper, TestClient):
...
def make_contract(symbol, sec_type, exch, expiry):
	contract = Contract()
...
#ibcontract = make_contract("VIX", "IND", "CBOE", "")
ibcontract = make_contract("VIX", "FUT", "CFE", "20180516")
#ibcontract = make_contract("EUR", "CASH", "IDEALPRO", "")
